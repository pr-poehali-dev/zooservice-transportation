...
export default function Index() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Services Section */}
      <section id="services" className="py-20 bg-green-25">
        <div className="container mx-auto px-4">
      ...
      {/* Tariffs Section */}
      <section id="tariffs" className="py-20 bg-orange-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
      ...
      {/* About Section */}
      <section id="about" className="py-20 bg-green-25">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
      ...
      {/* Contacts Section */}
      <section id="contacts" className="py-20 bg-orange-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
      ...
      {/* Footer */}
      <footer className="bg-orange-100 text-orange-900 py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-orange-800 transition-colors text-orange-700">Наземные перевозки</a></li>
                <li><a href="#" className="hover:text-orange-800 transition-colors text-orange-700">Авиаперевозки</a></li>
                <li><a href="#" className="hover:text-orange-800 transition-colors text-orange-700">Международные перевозки</a></li>
                <li><a href="#" className="hover:text-orange-800 transition-colors text-orange-700">Экстренная помощь</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-orange-800 transition-colors text-orange-700">О нас</a></li>
                <li><a href="#" className="hover:text-orange-800 transition-colors text-orange-700">Лицензии</a></li>
                <li><a href="#" className="hover:text-orange-800 transition-colors text-orange-700">Отзывы</a></li>
                <li><a href="#" className="hover:text-orange-800 transition-colors text-orange-700">Блог</a></li>
              </ul>
            </div>
